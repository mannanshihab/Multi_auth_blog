                ...
                <table class="content-table">
                    ...
                    <?php foreach ($categories as $category):?>
                        <tr>
                            ...
                            <td><?= $category ['post']?></td>
                            <td class='edit'><a href='update-category.php?id=<?= $category ['category_id']?>'><i class='fa fa-edit'></i></a></td>
                            <td class='delete'><a href='delete-category.php?id=<?= $category ['category_id']?>'><i class='fa fa-trash-o'></i></a></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
